...
public class RSSFeedActivity extends ListActivity {
    ...
    com.example.news.RSS.RSSParser rssParser = new RSSParser();
    Toolbar toolbar;

    List<com.example.news.RSS.RSSItem> rssItems = new ArrayList<>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String rss_link = getIntent().getStringExtra("url");
